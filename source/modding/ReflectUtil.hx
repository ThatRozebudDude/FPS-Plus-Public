...
class ReflectUtil
{
	...
	public static function hasClassField(cls:Class<Dynamic>, field:String):Bool{
		return Type.getClassFields(cls).contains(field);
	}

	public static function hasClassFieldOf(obj:Dynamic, field:String):Bool{
		return Type.getClassFields(Type.getClass(obj)).contains(field);
	}
	...
	public static function hasInstanceField(cls:Class<Dynamic>, field:String):Bool{
		return Type.getInstanceFields(cls).contains(field);
	}

	public static function hasInstanceFieldOf(obj:Dynamic, field:String):Bool{
		return Type.getInstanceFields(Type.getClass(obj)).contains(field);
	}
