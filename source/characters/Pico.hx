...
class Pico extends CharacterInfoBase
{
    ...
    override public function new(){
		...
		addByPrefix('singRIGHTmiss', offset(-40, 49), 'Pico Note Right Miss', 24, false);
		addByPrefix('singLEFTmiss', offset(82, 27), 'Pico NOTE LEFT miss', 24, false);
		addByPrefix('singUPmiss', offset(26, 67), 'pico Up note miss', 24, false);
		addByPrefix('singDOWNmiss', offset(86, -37), 'Pico Down Note MISS', 24, false);
