...
class AutoOffsetState extends MusicBeatState
{
	...
	function exit():Void {
		...
		ending = true;
		Config.write(offsetCalc, Config.accuracy, Config.healthMultiplier, Config.healthDrainMultiplier, Config.betterIcons, Config.downscroll, Config.newInput, Config.noteGlow, Config.noRandomTap, Config.noFpsCap);
