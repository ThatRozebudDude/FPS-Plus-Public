...
class Utils
{
	...
	*/
	...
	//Forces the calling of functions generated by the existence macro etc. at compile time
	//It's quite dangerous so only use it if absolutely necessary!
	public static inline function forceCall(from:Class<Dynamic>, func:String, ?args:Array<Dynamic>):Dynamic{
