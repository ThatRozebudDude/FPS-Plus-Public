...
class CacheReload extends FlxState
{
	...
	public static final defaultCharacterPreloadList:Array<String> = [
		"shared/boyfriend/*", "shared/boyfriend_dead/*", "week4/boyfriend_car/*", "week5/boyfriend_christmas/*", "week6/bfPixel", "week6/bfPixelsDEAD", "week7/bf_and_gf/*", "week7/bf_and_gf_dead/*",
