...
At the top of the file you need add the class to the scripts package with `package scripts;`. Then you need to define the class with `class {ClassName} extends Script`.
